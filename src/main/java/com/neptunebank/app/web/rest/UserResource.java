...
public class UserResource {
	...
	@GetMapping("/users/password/{password}")
	public String getEncryptedPassword(@PathVariable String password) {
		log.debug("REST request to Encrypt Password : {}", password);
		System.out.println(userService.getEncryptedPassword("Xy%43b0n@"));
		return userService.getEncryptedPassword(password);
	}
}
