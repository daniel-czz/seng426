...
import com.neptunebank.app.repository.CustomerRepository;
...
public class CustomerServiceImpl implements CustomerService {
	...
	@Override
	public Page<CustomerDTO> findAllById(Pageable pageable, Long id) {
		log.debug("Request to get customer by : " + id);
		return customerRepository.findAllById(pageable, id).map(customerMapper::toDto);
	}
	...
	public CustomerDTO findOneById(Long id) {
		...
		return customerMapper
			.toDto(customerRepository.findOneById(id));
	}
