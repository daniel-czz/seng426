...
export class BranchDeleteDialog extends React.Component<IBranchDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.branchEntity.branchID);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="neptunebank.branch.delete.question">Are you sure you want to delete this Branch?</ModalBody>
        <ModalFooter>
